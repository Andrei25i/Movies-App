    ...
    useEffect(() => {
        ...
        if (savedState) {
            ...
            Promise.all([
                ...
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=28', options).then(res => res.json()).then(data => setAction(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=12', options).then(res => res.json()).then(data => setAdventure(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=16', options).then(res => res.json()).then(data => setAnimation(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=35', options).then(res => res.json()).then(data => setComedy(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=18', options).then(res => res.json()).then(data => setDrama(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=10751', options).then(res => res.json()).then(data => setFamily(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=27', options).then(res => res.json()).then(data => setHorror(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=9648', options).then(res => res.json()).then(data => setMystery(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=878', options).then(res => res.json()).then(data => setSf(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=53', options).then(res => res.json()).then(data => setThriller(shuffleArray(data.results))),
                fetch('https://api.themoviedb.org/3/discover/movie?certification.lte=R&certification_country=US&include_adult=false&include_video=false&language=en-US&page=1&with_genres=10752', options).then(res => res.json()).then(data => setWar(shuffleArray(data.results))),
